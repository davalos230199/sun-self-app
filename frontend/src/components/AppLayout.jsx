...
// =================================================================
// INICIO: Componente Navbar integrado para evitar errores de importación
// =================================================================
...
// =================================================================
// FIN: Componente Navbar integrado
// =================================================================
...
export default function AppLayout({ user }) {
  ...
  return (
    <div className="h-screen w-screen bg-zinc-100 flex items-center justify-center p-2 sm:p-4">
      <div className="
        relative
