...
// =================================================================
// INICIO: Componente Navbar (sin cambios)
// =================================================================
...
export default function AppLayout({ user }) {
  ...
  return (
    // Contenedor exterior: define el fondo y usa la altura dinámica correcta
    <div className="h-[100dvh] w-screen bg-zinc-100 p-2 sm:p-4">
      
      {/* La "tarjeta" de la app: usa h-full para llenar el espacio del padre */}
      <div className="
        h-full
